---
title: "Embracing the Uncertainty of Advanced Attacks Using Big Data Analytics"
published: false
tags: security, bigdata, analytics, infosec
canonical_url: https://crlab.ca/learn/security-research/embracing-the-uncertainty-of-advanced-attacks-using-big-data-analytics/
cover_image: https://crlab.ca/assets/og-default.png
---

> By **Zubair Ashraf** · Originally published on [IBM SecurityIntelligence](https://web.archive.org/web/20140614042817/https://securityintelligence.com/embracing-the-uncertainty-of-advanced-attacks-using-big-data-analytics/), 2014 · archived copy, republished here.

In my continuing series of keynote recaps, I’d like to discuss two talks that center on using big data analytics to offset the uncertainty of advanced cyber attacks. The first is the keynote from the fourth annual [Hack in the Box](https://www.youtube.com/watch?v=RhmYZuI14Nk&index=2&list=PLmv8T5-GONwRLoHaiTDNkbkS-YsByie24) (HITB) security conference in Amsterdam by Eddie Schwartz ([@eddieschwartz](https://twitter.com/eddieschwartz)), who also coauthored the related paper [Big Data Fuels Intelligence-Driven Security](http://www.emc.com/collateral/industry-overview/big-data-fuels-intelligence-driven-security-io.pdf). The second is an RSA 2014 talk, [Securing the Big Data Ecosystem](http://www.rsaconference.com/videos/152/securing-the-big-data-ecosystem) by Davi Ottenheimer ([@daviottenheimer](https://twitter.com/daviottenheimer)).
...
One of the points that Schwartz mentioned is to start moving from big data knowledge to big data deployment. He also talks about outsourcing and partnering for some of these roles, and says that companies should start asking partners and [vendors](http://www-03.ibm.com/software/products/en/subcategory/security-intelligence) about how they are adopting nontraditional analytics.

[ White Paper: Leverage Big Data Analytics to improve enterprise security __](https://www.ibm.com/services/forms/signup.do?source=swg-WW_Security_Organic&S_PKG=ov19871&S_TACT= 102PW2CW)

---

*Originally published at [crlab.ca/learn/security-research/embracing-the-uncertainty-of-advanced-attacks-using-big-data-analytics/](https://crlab.ca/learn/security-research/embracing-the-uncertainty-of-advanced-attacks-using-big-data-analytics/). Follow CR Labs — [YouTube](https://crlab.ca) · [X](https://x.com/zashraf1337) · [LinkedIn](https://www.linkedin.com/in/zubairashraf/).*
